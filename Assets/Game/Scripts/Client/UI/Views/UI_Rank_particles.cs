...
namespace Game.Client.UI
{
    ...
    {
        [Header("Spawn Settings")] public RectTransform spawnPoint;
        ...
        [Header("Particle Visual Settings")] public Color particleColor = Color.white;

        [Tooltip("Начальный масштаб частицы")] public float startScale = 1f;
