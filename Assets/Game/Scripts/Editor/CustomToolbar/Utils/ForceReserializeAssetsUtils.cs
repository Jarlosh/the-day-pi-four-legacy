...
namespace Game.Editor
{
	public static class ForceReserializeAssetsUtils
	{
		...
		{
			if (!EditorUtility.DisplayDialog("Attention", "Do you want to force reserialize all assets? This can be time heavy operation and result in massive list of changes.",
					"Ok", "Cancel"))
			{
				return;
			}
